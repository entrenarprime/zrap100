CLASS zcl_rap100_gen_data_4034 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_4034 IMPLEMENTATION.
...
*   clear data
    ...
    COMMIT WORK.
    out->write( |[RAP100] Demo data generated for table ztravel_4034 { group_id }. | ).
